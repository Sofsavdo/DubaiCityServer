          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
            ...
            <CardContent>
              ...
              <div className="flex items-center text-xs text-orange-700 mt-1">
                ...
                {stats.pendingRequests} kutilmoqda
              </div>
            </CardContent>
          </Card>
        </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span>{stats.customerSatisfaction}%</span>
                    </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-600">{formatCurrency(stats.monthlyProfit)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Komissiya</span>
                      <span className="font-medium text-purple-600">{formatCurrency(stats.commission)}</span>
                    </div>
                    <div className="flex justify-between">
